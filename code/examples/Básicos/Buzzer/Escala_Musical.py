...
def tocar_nota(nota, duracao):
    if nota in NOTES:
        ...
        buzzer.duty_u16(1000)      # Define o volume (ajustável)
        sleep(duracao)             # Toca a nota pelo tempo definido
        buzzer.duty_u16(0)         # Para o som
        sleep(0.5)                 # Pausa curta entre as notas

# Melodia completa de "Parabéns pra Você"
melodia = [
    ("C", 0.5), ("D", 0.5), ("E", 0.5), ("F", 0.5), ("G", 0.5), ("A", 0.5), ("B", 0.5)
]
...
# Programa principal
print("Tocando a melodia completa de 'Escala Musical'")
